...
<head>
	...
	<title>Win Radio Admin - New What's Hot Entry</title>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">Create What's Hot Entry</h1>
					</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="alert bg-success" id="alertPublishSuccess" style="display:none;" role="alert">
							<em class="fa fa-check-circle mr-2"></em> <%=CodeUtil.STATUS_POST_PUBLISHED %>
						...
						<div class="alert bg-success" id="alertDraftSuccess" style="display:none;" role="alert">
							<em class="fa fa-check-circle mr-2"></em> <%=CodeUtil.STATUS_DRAFT_SAVED %>
						...
						<div class="alert bg-danger" id="alertMissingField" style="display:none;" role="alert">
							<em class="fa fa-minus-circle mr-2"></em> <%=CodeUtil.STATUS_MSG_NULL_FIELD %>
						...
						<div class="card">
							<div class="card-block">
								<form class="form-horizontal">		
									...
									<%} %>
									<div class="form-group">
								        <label for="message-text" class="form-control-label">URL: (for linked posts)</label>
									...
									<div class="form-group">
										<fieldset class="form-group">
									    	<label class="col-12 control-label no-padding" for="message">Save entry as:</label>
									...
									<div class="form-group">
										<div class="col-12 widget-right no-padding">
											<button type="button" class="btn btn-primary btn-md float-right" onclick="createEntry()">Submit</button>
										</div>
									</div>
								</form>
							</div>
