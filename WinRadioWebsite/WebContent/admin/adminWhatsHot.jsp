<%@page import="com.win.radio.manila.utilities.WhatsHotCommands"%>
...
<head>
	...
	<title>Win Radio Admin - What's Hot</title>
...
<body>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">What's Hot Maintenance</h1>
					</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="alert bg-warning" id="alertNoRowSelected" style="display:none;" role="alert">
							<em class="fa fa-minus-circle mr-2"></em> <%=CodeUtil.STATUS_MSG_NO_SELECTED %>
			        	...
			        	<div class="card mb-3">
								<div class="table-responsive">
									<table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
										<thead>
						                	<tr>
							                  	<th style="display:none;">ID Entry</th>
							                  	<th>Creation Date</th>
										...
										<tbody>
						            		...
						            		try{	 
						                 	...
						                 	pstmt = conn.prepareStatement(WhatsHotCommands.GET_WHATS_HOT);
						                 	pstmt.setString(1, "%");
											...
											<tr class="clickableRow">								
												<td style="display:none;"><%=rs.getString("ID_ENTRY")%></td>
    ...
    function createPost() {
    	window.location.href='adminNewWhatsHotEntry.jsp?';
    }
    </script>
