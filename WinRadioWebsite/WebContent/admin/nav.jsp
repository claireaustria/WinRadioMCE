...
<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
	...
	<ul class="nav nav-pills flex-column sidebar-nav" id="#navbarResponsive">
		...
		<%if (strAcctType.equals(CodeUtil.COD_TYPE_SUPER_USER) || strAcctType.equals(CodeUtil.COD_TYPE_CONTENT_MANAGER)) { %>
			...
			<li class="nav-item"><a class="nav-link ${pageContext.request.requestURI eq '/WinRadioWebsite/admin/adminWhatsHot.jsp' ? ' active' : ''}" href="adminWhatsHot.jsp"><em class="fa fa-newspaper-o"></em> What's Hot </a></li>
