<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
	...
	<ul class="nav nav-pills flex-column sidebar-nav" id="#navbarResponsive">
		...
		<li class="nav-item"><a class="nav-link ${pageContext.request.requestURI eq '/WinRadioWebsite/manila/#.jsp' ? ' active' : ''}" href="#"><em class="fa fa-newspaper-o"></em> What's Hot </a></li>
		<li class="nav-item"><a class="nav-link ${pageContext.request.requestURI eq '/WinRadioWebsite/manila/adminProgramSchedule.jsp' ? ' active' : ''}" href="adminProgramSchedule.jsp"><em class="fa fa-calendar-check-o"></em> Program Sched</a></li>
		<li class="nav-item"><a class="nav-link ${pageContext.request.requestURI eq '/WinRadioWebsite/manila/adminDrama.jsp' ? ' active' : ''}" href="#"><em class="fa fa-book"></em> Heart Stories </a></li>
