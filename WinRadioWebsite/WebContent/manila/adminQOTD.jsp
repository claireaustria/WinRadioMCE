			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					<div class="col-md-6 col-lg-8" >
						<h1 class="float-left text-center text-md-left">DJ Question Maintenance</h1>
					</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<a href="adminNewQOTD.jsp">
						<button type="submit" class="btn btn-primary btn-md float-right btn-options" id="btnNewQOTD">Post New Question</button>
						</a>
						<a href="">
							<button type="submit" class="btn btn-primary btn-md float-right btn-options" id="">Modify Details</button>
						</a>
					</div>
				</div>
