...
<nav id="primary-menu" class="dark">
	<ul>
		<li class="current"><a class="" href="index.jsp"><div>Home</div></a></li>
		<li><a href="programs.jsp"><div>Programs</div></a></li>
		<li><a href="heart-stories.jsp"><div>Heart Stories</div></a></li>
		<li class="${pageContext.request.requestURI eq 'WinRadioWebsite/manila/pages/djBlogs.jsp' ? 'current' : ''}"><a href="dj-blogs.jsp"><div>DJ Blogs</div></a></li>
	...
	<div id="top-cart">
		...
		<div class="top-cart-content">
			<div class="top-cart-title">
				<a href=""><h4>Change location</h4></a>
			</div>
		</div>
	</div><!-- #top-cart end -->
</nav>