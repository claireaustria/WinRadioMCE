...
public interface BlogContentCommands {
	/* JSP SCRIPTS */
	public String GET_BLOG_POSTS = "SELECT FORMAT(B.CREATE_DATE, 'MMM dd yyyy') + ' ' + CONVERT(varchar(15),CAST(B.CREATE_DATE AS TIME),100) as 'CREATE_DATE', " +
			"FORMAT(B.UPDATE_DATE, 'MMM dd') + ' ' + CONVERT(varchar(15),CAST(B.UPDATE_DATE AS TIME),100) as 'UPDATE_DATE', " +
			"FORMAT(B.CREATE_DATE, 'MMM dd, yyyy') AS DATE_POSTED, " +
			...
			"SUBSTRING(B.CONTENT, 1,300) + '...' AS BLOG_PREVIEW  " +
			"FROM BLOG_CONTENT B " +
