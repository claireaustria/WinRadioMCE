...
public interface IndexCommands {
	...
	public String GET_ALL_MRH = "SELECT * FROM MOST_REQUESTED_HITS WHERE COD_REGION = ? ORDER BY ID_MRH ASC";
	...
	public String GET_ALL_DJ = "SELECT * FROM DJLIST WHERE COD_REGION = ?";
}
