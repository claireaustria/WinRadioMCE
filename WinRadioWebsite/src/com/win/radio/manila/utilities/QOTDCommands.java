...
public interface QOTDCommands {
	...
	public String GET_ALL_QUESTION = "SELECT FORMAT(Q.CREATE_DATE, 'MM/dd/yyyy') AS CREATE_DATE, Q.QUESTION, "
			+ "Q.ID_QUESTION, Q.IND_POST, A.USERNAME, D.DJ_NAME, FORMAT(Q.UPDATE_DATE, 'MM/dd/yyyy') "
