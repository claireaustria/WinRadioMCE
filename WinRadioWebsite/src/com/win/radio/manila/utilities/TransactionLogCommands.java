...
public interface TransactionLogCommands {
	...
	/* JSP SCRIPTS */
	public String GET_TRANSACTION_LOGS = "SELECT TOP (4) FORMAT(T.CREATE_DATE, 'MMM dd') + ' ' + CONVERT(varchar(15),CAST(T.CREATE_DATE AS TIME),100) as 'CREATE_DATE', A.FIRST_NAME + ' ' + A.LAST_NAME + ' ' + T.DESCRIPTION AS 'EVENT' " + 
